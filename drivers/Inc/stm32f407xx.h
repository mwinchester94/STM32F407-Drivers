...
#define PERIPH_BASEAADR			0x40000000U
#define APB1PERIPH_BASEADDR		PERIPH_BASEAADR
...
typedef struct
{
	...
	__vo uint32_t OTYPER;			//TODO: add description		Address offset: 0x04
...
/*
 * Include other driver header files
 */
